...
export default class extends React.Component {
  ...
  render() {
    ...
    const content = getParsedByContentType("Content-Type:" + type + "/xml", detail.content, "", 60);
    return (
      <div className="record-box">
        <div className="short">
          <i className="iconfont icon-link margin-right-0-5em"></i><a className="ellipsis max-width-20" onClick={this.showOrHide}>{"[" + this.t('link') + "]"}</a>
        </div>
          ...
          <div>
            <div className="link-box">
              <div className="header-box">
                <span>{this.t('linkInfo')}</span>
                <Icon type="cross" onClick={this.showOrHide} />
              </div>
              <div className="link-info" dangerouslySetInnerHTML={{__html:content}}></div>
