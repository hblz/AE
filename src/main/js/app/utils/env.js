...
class ENV {
  ...
  get vOrgUC() {
    return (() => {
      switch (this.current) {
        ...
        case ENV.awsca:
          return 'https://vorg-awsca.101.com'
        case ENV.wjt:
          return 'https://vorgwjt.101.com'
        case ENV.dyejia:
  ...
  getAPI(prefix, overrides) {
    return ({
      ...
      [ENV.oldBeta]: `https://${prefix}.beta.101.com`,
      ...
      [ENV.wjt]: `http://${prefix}.wjt.101.com`,
